	...
	*/
	...
	$(function(){
		...
		ListView = Backbone.View.extend({
			...
			initialize: function(){
				_.bindAll(this, 'render', 'addItem', 'editTitle', 'removeLane', 'appendItem','prepareItem'); // every function that uses 'this' as the current object should be in here
		...
		*/
		...
		if (edit === true)
		{
			...
			else
			{
				...
				{
					$("<span class='tagRemoval' <span>TAGGED: </span><span class='taggedUser'> "+tags[i]+"</span> (click to remove)</span><br/>").appendTo(".oldTagBar");	
				}	
			}			
		}
	}
